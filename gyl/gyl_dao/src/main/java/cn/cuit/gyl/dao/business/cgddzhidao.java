...
public interface cgddzhidao {
    ...
    @Insert("insert into cgzhib(id,hh,spbm,spmc,hgb,gbr,gbrq,gg,xh,sl,dw,hsdj,wsdj,shuilv,hsje,wsje,se,zp,lydj,ljthsl,hstatus,zid,shck,fhdw,jhdhrq,yqshrq,yfwrksl,ljdhsl,ljrksl,ljkpsl,ljyfsl,sfdhgb,sfrkgb,sfkpgb,sffkgb)value(#{cgddzhibid},#{hh},#{spbm},#{spmc},#{hgb},#{gbr},#{gbrq},#{gg},#{xh},#{sl},#{dw},#{hsdj},#{wsdj},#{shuilv},#{hsje},#{wsje},#{se},#{zp},#{lydj},#{ljthsl},#{hstatus},#{zid},#{shck},#{fhdw},#{jhdhrq},#{yqshrq},#{yfwrksl},#{ljdhsl},#{ljrksl},#{ljkpsl},#{ljyfsl},#{sfdhgb},#{sfrkgb},#{sfkpgb},#{sffkgb})")
    ...
    @Update("update cgzhib set hh=#{hh},spbm=#{spbm},spmc=#{spmc},hgb=#{hgb},gbr=#{gbr},gbrq=#{gbrq},gg=#{gg},xh=#{xh},sl=#{sl},dw=#{dw},hsdj=#{hsdj},wsdj=#{wsdj},shuilv=#{shuilv},hsje=#{hsje},wsje=#{wsje},se=#{se},zp=#{zp},lydj=#{lydj},ljthsl=#{ljthsl},hstatus=#{hstatus} ,zid = #{zid},shck=#{shck},fhdw=#{fhdw},jhdhrq=#{jhdhrq},yqshrq=#{yqshrq},yfwrksl=#{yfwrksl},ljdhsl=#{ljdhsl},ljrksl=#{ljrksl},ljkpsl=#{ljkpsl},ljyfsl=#{ljyfsl},sfdhgb=#{sfdhgb},sfrkgb=#{sfrkgb},sfkpgb=#{sfkpgb},sffkgb=#{sffkgb} where id = #{cgddzhibid}")
