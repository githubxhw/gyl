                    ...
                    <section class="content"> <!--产品信息-->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="row data-type">
                                <%--1--%>
<%--                                <div class="col-md-2 title">供应商ID</div>--%>
<%--                                <div class="col-md-4 data">--%>
<%--                                    <input type="text" class="form-control" name="id"--%>
<%--                                           placeholder="供应商ID" value="">--%>
<%--                                </div>--%>
                                ...
                                <%--2--%>
                                <div class="col-md-2 title">供应商全称</div>
                                <div class="col-md-4 data">
                                    <input type="text" class="form-control" name="fullname"
                                           placeholder="供应商全称" value="">
                                </div>
                ...
                <form action="${pageContext.request.contextPath}/gys/Deletes" method="post">
                    <div class="box-body">
                        ...
                        <div class="table-box" style="overflow: scroll;overflow-y:scroll;height: 200px;width: 99%;">
                            ...
                            <table id="dataList" class="table table-bordered table-striped table-hover dataTable"  style="min-width:4000px;border:solid grey 1px">
                                ...
                                <tr>
                                    ...
                                    <th class="sorting_asc" width="150px">供应商ID</th>
                                ...
                                <%--内容--%>
                                <tbody>
                                <c:forEach items="${pb.list}" var="gys">
                                    <tr>
                                        <td><input name="ids" type="checkbox" value="${gys.id}"></td>
                                        <td>${gys.id}</td>
                                        <td>${gys.name}</td>
                                        <td>${gys.fullname}</td>
                                        <td>${gys.zjm}</td>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/gys/findById?id=${gys.id}'">修改</button>
                                            <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/gys/Delete?id=${gys.id}'">删除</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/pages/basedata/gys-add.jsp'"><i
                                            class="fa fa-file-o"></i> 新建
                                    </button>
                                    <button type="submit" class="btn btn-default" title="删除"><i
                                            class="fa fa-trash-o"></i> 删除
                                    </button>
                                    <button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/gys/findByPage?currentPage=${pb.currentPage}&rows=5 '"><i
                            ...
                            <ul class="pagination">
                                ...
                                <c:forEach begin="1" end="${pb.totalPage}" var="i" >
                                    ...
                                    <c:if test="${pb.currentPage == i}">
                                        <li class="active"><a href="${pageContext.request.contextPath}/gys/findByPage?currentPage=${i}&rows=5&id=${Gys.id}&name=${Gys.name}&fullname=${Gys.fullname}&zjm=${Gys.zjm}&jc=${Gys.jc}&dz=${Gys.dz}&status=${Gys.status}&qy=${Gys.qy}&hy=${Gys.hy}&lxr=${Gys.lxr}&dh=${Gys.dh}&mdh=${Gys.mdh}&cz=${Gys.cz}&yb=${Gys.yb}&email=${Gys.email}&khyh=${Gys.khyh}&yhzh=${Gys.yhzh}&swdjh=${Gys.swdjh}&zzsl=${Gys.zzsl}&gj=${Gys.gj}">${i}</a></li>
                                    </c:if>
                                    <c:if test="${pb.currentPage != i}">
                                        <li><a href="${pageContext.request.contextPath}/gys/findByPage?currentPage=${i}&rows=5&id=${Gys.id}&name=${Gys.name}&fullname=${Gys.fullname}&zjm=${Gys.zjm}&jc=${Gys.jc}&dz=${Gys.dz}&status=${Gys.status}&qy=${Gys.qy}&hy=${Gys.hy}&lxr=${Gys.lxr}&dh=${Gys.dh}&mdh=${Gys.mdh}&cz=${Gys.cz}&yb=${Gys.yb}&email=${Gys.email}&khyh=${Gys.khyh}&yhzh=${Gys.yhzh}&swdjh=${Gys.swdjh}&zzsl=${Gys.zzsl}&gj=${Gys.gj}">${i}</a></li>
                                    </c:if>

                                </c:forEach>


                                <li><a href="${pageContext.request.contextPath}/gys/findByPage?currentPage=${pb.currentPage+1}&rows=5&id=${Gys.id}&name=${Gys.name}&fullname=${Gys.fullname}&zjm=${Gys.zjm}&jc=${Gys.jc}&dz=${Gys.dz}&status=${Gys.status}&qy=${Gys.qy}&hy=${Gys.hy}&lxr=${Gys.lxr}&dh=${Gys.dh}&mdh=${Gys.mdh}&cz=${Gys.cz}&yb=${Gys.yb}&email=${Gys.email}&khyh=${Gys.khyh}&yhzh=${Gys.yhzh}&swdjh=${Gys.swdjh}&zzsl=${Gys.zzsl}&gj=${Gys.gj}">下一页</a></li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/gys/findByPage?currentPage=${pb.totalPage}&rows=5&id=${Gys.id}&name=${Gys.name}&fullname=${Gys.fullname}&zjm=${Gys.zjm}&jc=${Gys.jc}&dz=${Gys.dz}&status=${Gys.status}&qy=${Gys.qy}&hy=${Gys.hy}&lxr=${Gys.lxr}&dh=${Gys.dh}&mdh=${Gys.mdh}&cz=${Gys.cz}&yb=${Gys.yb}&email=${Gys.email}&khyh=${Gys.khyh}&yhzh=${Gys.yhzh}&swdjh=${Gys.swdjh}&zzsl=${Gys.zzsl}&gj=${Gys.gj}" aria-label="Next">尾页</a>
                                </li>
                            </ul>
                        </div>
