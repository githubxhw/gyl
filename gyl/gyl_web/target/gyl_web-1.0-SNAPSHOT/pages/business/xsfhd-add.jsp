    ...
    function add_zib(x) {
        ...
        if (flag == "1") {
            ...
            var str = '<tr id="' + nowCount + '">' +
                ...
                '<td>                            <input readonly="readonly" id="ljcksl-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].ljcksl" ' +
                '                                   placeholder="累计出库数量" value="0"></td>\n' +
                '<td>                            <input readonly="readonly" id="ljkpsl-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].ljkpsl" ' +
                '                                   placeholder="累计开票数量" value="0"></td>\n' +
                '<td>                            <select id="sfckjs-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].sfckjs">\n' +
                '                                   <option selected="selected" value="0">未结束</option>' +
                '<td>                            <select id="sfkpjs-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].sfkpjs">\n' +
                '                                   <option selected="selected" value="0">未结束</option>' +
                '                                </select></td>\n' +
