        ...
        <section class="content">
            <div class="error-page">
                <h2 class="headline text-yellow">
                    <c:if test="${tip.status != null}">
                        ${tip.status}
                    </c:if>
                </h2>

                <div class="error-content" style="font-size: large">
                    <h3><i class="fa fa-warning text-yellow"></i>提示</h3>

                    <p>
                        ${tip.msg}<br>
                        <c:if test="${tip.isRedirect == true}">Please go &nbsp;<a href="${pageContext.request.contextPath}/${tip.url}">here</a>&nbsp; to do something.</c:if>
                    </p>
