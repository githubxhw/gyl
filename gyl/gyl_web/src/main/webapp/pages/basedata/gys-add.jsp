...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/gys/Save"
              method="post" id="form">
            <!-- 正文区域 -->
            <section class="content"> <!--产品信息-->
                ...
                <div class="box-tools text-center">
                    <button type="submit" class="btn bg-maroon" id="keep">保存</button>
...
<script>
    ...
    $(function () {
        document.getElementsByName("name")[0].onblur = function () {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/gys/FindName",
                type: "POST",
                data: {"name":name},
                dataType: "json",
                async: false,
