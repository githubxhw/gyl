...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                供应商 <small>供应商表单</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="${pageContext.request.contextPath}/index.jsp"><i
                        class="fa fa-dashboard"></i> 首页</a></li>
                <li><a
                        href="${pageContext.request.contextPath}/gys/findByPage">供应商</a></li>
                <li class="active">供应商表单</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/gys/Update" method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="mdh"
                                   placeholder="移动电话" value="${gys.mdh}">
                        </div>
...
<script>
    ...
    $(function () {
        document.getElementsByName("name")[0].onblur = function () {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/gys/FindNameU",
                type: "POST",
        ...
        document.getElementsByName("fullname")[0].onblur = function () {
            ...
            var id = document.getElementsByName("id")[0].value;
            $.ajax({
                url: "${pageContext.request.contextPath}/gys/FindFullNameU",
                type: "POST",
                data: {"name":name,"id":id},
                dataType: "json",
                async: false,
