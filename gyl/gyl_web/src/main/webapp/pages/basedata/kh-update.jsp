...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/kh/Update" method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="xsms"
                                   placeholder="销售模式" value="${kh.xsms}">
                        </div>
                        <%--9--%>
...
<script>
    ...
    $(function () {
        document.getElementsByName("name")[0].onblur = function () {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/kh/FindNameU",
                type: "POST",
        ...
        document.getElementsByName("fullname")[0].onblur = function () {
            ...
            var id = document.getElementsByName("id")[0].value;
            $.ajax({
                url: "${pageContext.request.contextPath}/kh/FindFullNameU",
                type: "POST",
                data: {"name":name,"id":id},
                dataType: "json",
                async: false,
        ...
        document.getElementsByName("zjm")[0].onblur = function () {
            ...
            var id = document.getElementsByName("id")[0].value;
            $.ajax({
                url: "${pageContext.request.contextPath}/kh/FindZjmU",
                type: "POST",
                data: {"zjm":name,"id":id},
                dataType: "json",
                async: false,
