        ...
        <section class="content">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title" style="font-weight: bold">权限名称：${permission.permission_name},权限描述：${permission.permission_desc}</h3>
                </div>
                &nbsp;&nbsp;&nbsp;<span style="font-weight: bold">拥有该权限角色列表</span>
                <div class="box-body">
                    <!-- 数据表格 -->
                    <div class="table-box">
                        <!--数据列表-->
