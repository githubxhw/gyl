            ...
            <div class="box box-primary">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center sorting">权限名称</th>
                                <th class="text-center sorting">权限描述</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="location.href='${pageContext.request.contextPath}/privilege/findRolesByPermissionId?permissionId=${permission.id}'">
                                            拥有角色详情
                                        </button>
                                    </td>
                                </tr>
                ...
                <c:if test="${not empty pageInfo.list}">
                    ...
                    <div class="box-footer">
                        ...
                        <div class="box-tools pull-right">
                            <ul class="pagination">
                                <li><a href="${pageContext.request.contextPath}/privilege/findAllPrivileges?pageNum=1&pageSize=10"
                                       aria-label="Previous">首页</a></li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/privilege/findAllPrivileges?pageNum=${pageInfo.pageNum-1}&pageSize=10">上一页</a>
                                </li>

                                <c:if test="${pageInfo.pages <= 5}">
                                    <c:forEach begin="1" end="${pageInfo.pages}" var="index">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/privilege/findAllPrivileges?pageNum=${index}&pageSize=10">${index}</a>
                                        </li>
                                    </c:forEach>
                                </c:if>
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/privilege/findAllPrivileges?pageNum=${pageInfo.pageNum+1}&pageSize=10">下一页</a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/privilege/findAllPrivileges?pageNum=${pageInfo.pages}&pageSize=10"
