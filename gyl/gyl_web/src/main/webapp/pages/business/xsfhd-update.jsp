            ...
            <section class="content">
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <select class="form-control" name="sfkpjs">
                                <option value="0">否</option>
                            </select>
                        </div>
        ...
        <from><%--提交ids--%>
            ...
            <div style="overflow: scroll;overflow-y:scroll;height: 200px;width: 99%;">
                <table id="dataList_zhu" class="table table-bordered table-striped table-hover dataTable"
                    ...
                    <th class="text-center sorting" width="200px">是否开票结束</th>
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < xsfhd_zhubs.length; i++) {
                        html += '<tr>\n' +
                            ...
                            '                                                                <div class="col-md-4 data">\n' +
                            '                                                                    <select class="form-control" name="sfkpjs">\n' +
                            '                                                                        <option id="zhub_xg_sfkpjs0_option-' + i + '" value="0">否</option>\n' +
                            '                                                                    </select>\n' +
                            '                                                                </div>\n' +
                            '                                                                <div class="col-md-2 title">状态</div>\n' +
                            '                                                                <div class="col-md-4 data">\n' +
            ...
            success: function (data) {
                ...
                for (var i = 0; i < xsfhd_zibs.length; i++) {
                    html += '<tr>\n' +
                        ...
                        '<td>' + xsfhd_zibs[i].ljcksl + '</td>\n' +
                        '<td>' + xsfhd_zibs[i].ljkpsl + '</td>\n' +
                        '<td>' + xsfhd_zibs[i].sfckjsStr + '</td>\n' +
                        '<td>' + xsfhd_zibs[i].sfkpjsStr + '</td>\n' +
                        ...
                        '                                    <option id="zib_xg_sfckjs0_option-' + i + '" value="0">否</option>\n' +
                        '                             </select>\n' +
                        '                          </div>\n' +
                        '                         <div class="col-md-2 title">是否开票结束</div>\n' +
                        '                         <div class="col-md-4 data">\n' +
                        '                             <select id="zib_xg_select_sfkpjs-' + i + '" class="form-control" name="sfkpjs">\n' +
                        '                                    <option id="zib_xg_sfkpjs0_option-' + i + '" value="0">否</option>\n' +
                        '                             </select>\n' +
                        '                          </div>\n' +
                        '                         <div class="col-md-2 title">状态</div>\n' +
                        '                         <div class="col-md-4 data">\n' +
        ...
        if(zib_status == 1){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#zib_xg_ljcksl-" + i).attr("value", xsfhd_zib.ljcksl);
                    $("#zib_xg_ljkpsl-" + i).attr("value", xsfhd_zib.ljkpsl);
