            ...
            if(confirm(msg) == true){
                ...
                if(spr.length <= 0 || spr == null || spr == undefined){
                    ...
                    if(sprq.length <= 0 || sprq == null || sprq == undefined){
                        ...
                        $.ajax({
                            url: "${pageContext.request.contextPath}/xskpd/spForbidden",
                            type: "GET",
                            data: {"fph":ddh,"spr":spr,"sprq":sprq},
                            dataType: "text",
                            //async: false,
                            success: function (data) {
                                $("#query").trigger("click");
            ...
            if(confirm(msg) == true) {
                ...
                if(spr.length <= 0 || spr == null || spr == undefined){
                    ...
                    if(sprq.length <= 0 || sprq == null || sprq == undefined){
                        ...
                        $.ajax({
                            url: "${pageContext.request.contextPath}/xskpd/spAdopt",
                            type: "GET",
                            data: {"fph":ddh,"spr":spr,"sprq":sprq},
                            dataType: "text",
                            //async: false,
