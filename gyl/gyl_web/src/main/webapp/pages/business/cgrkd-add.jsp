        ...
        <form id="form" method="post">
            <section class="content">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">填写采购入库单信息进行添加</div>
                    <div class="row data-type">
                        <div class="col-md-2 title">入库号</div>
                        <div class="col-md-4 data">
                            <input id="zhub_ddh" readonly="readonly" type="text" class="form-control" name="djh"
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#save_button").click(function () {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/cgrkd/saveZhubAndZib",
                type: "post",
                data: params,
                dataType: "json",
                async: false,
                success: function (data) {
                    ...
                    if(resFlag == "1"){ //成功
                        alert("添加成功!");
                        window.location.href = "${pageContext.request.contextPath}/cgrkd/getDdhToAddUI";
                    }else { //失败
                        alert("添加失败:"+msgList);
                        $.ajax({
                            url: "${pageContext.request.contextPath}/cgrkd/getDdh",
                            type: "get",
                            data: {},
                            dataType: "text",
                            async: false,
        ...
        $("#toquery_button").click(function () {
            window.location.href = "${pageContext.request.contextPath}/pages/business/cgrkd-query.jsp";
        });
    });
    ...
    function add_zib(x) {
        ...
        if (flag == "1") {
            ...
            var str = '<tr id="' + nowCount + '">' +
                ...
                '                                </button>' +
                '</td>' +
                '<td>                            <input id="hh-' + nowCount + '" type="text" readonly="readonly"  class="form-control" name="cgrkd_zibs[' + nowCount + '].hh"\n' +
                ...
                '<td>                            <input id="type-' + nowCount + '" type="text" class="form-control" name="cgrkd_zibs[' + nowCount + '].type"\n' +
                '                                   placeholder="型号" value=""></td>\n' +
                '<td>                            <input id="dw-' + nowCount + '" type="text" class="form-control" name="cgrkd_zibs[' + nowCount + '].dw"\n' +
                '                                   placeholder="计量单位" value=""></td>\n' +
                '<td>                            <input id="scrq-' + nowCount + '" type="text" class="form-control" name="cgrkd_zibs[' + nowCount + '].scrq"\n' +
                '                                   placeholder="生产日期" value=""></td >\n' +
                '<td>                            <input id="sxrq-' + nowCount + '" type="text" class="form-control" name="cgrkd_zibs[' + nowCount + '].sxrq"\n' +
                '                                   placeholder="失效日期" value=""></td >\n' +
                '<td>                            <input id="ydsl-' + nowCount + '" type="text" class="form-control" name="cgrkd_zibs[' + nowCount + '].ydsl"\n' +
                ...
                '<td>                            <input id="dj-' + nowCount + '" type="text" class="form-control" name="cgrkd_zibs[' + nowCount + '].dj"\n' +
                ...
                '<td>                            <input readonly="readonly" id="ljdhsl-' + nowCount + '" type="text" class="form-control" name="cgrkd_zibs[' + nowCount + '].ljrksl" ' +
                '                                   placeholder="累计入库数量" value="0"></td>\n' +
                '                                </select></td>\n' +
                '<td>                            <select id="status-' + nowCount + '" type="text" class="form-control" name="cgrkd_zibs[' + nowCount + '].status">\n' +
                '                                   <option selected="selected" value="0">未结束</option>' +
                '                                </select></td>\n' +
                '</tr>';
