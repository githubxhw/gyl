                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input readonly="readonly" type="text" class="form-control pull-right dateTimePicker" name="shrq">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input readonly="readonly" type="text" class="form-control pull-right dateTimePicker" name="xgrq">
                            </div>
                        </div>
            ...
            <div class="row data-type">
                ...
                <div class="col-md-4 data">
                    <div class="input-group date">
                        ...
                        <input id="sp_shrq" type="text" class="form-control pull-right dateTimePicker" value="">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#query").click(function () {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/cgrkd/findByCgrkd_zhub",
                type: "post",
                data: params,
                dataType: "json",
    ...
    function sp_forbidden(x) {
        ...
        if(djh.length <= 0 || djh == null || djh == undefined){
            alert("请选择要审批单据号进行审批!");
        }else {
            var msg = "确认审批禁止此订单?";
            if(confirm(msg) == true){
                ...
                if(spr.length <= 0 || spr == null || spr == undefined){
                    ...
                    if(shrq.length <= 0 || shrq == null || shrq == undefined){
                        ...
                        $.ajax({
                            url: "${pageContext.request.contextPath}/cgrkd/spForbidden",
                            type: "GET",
                            data: {"djh":djh,"spr":spr,"shrq":shrq},
                            dataType: "text",
                            //async: false,
                            success: function (data) {
                                $("#query").trigger("click");
            ...
            if(confirm(msg) == true) {
                ...
                if(spr.length <= 0 || spr == null || spr == undefined){
                    ...
                    if(shrq.length <= 0 || shrq == null || shrq == undefined){
                        ...
                        $.ajax({
                            url: "${pageContext.request.contextPath}/cgrkd/spAdopt",
                            type: "POST",
                            data: {"djh":djh,"spr":spr,"shrq":shrq},
                            dataType: "text",
                            //async: false,
