                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" name="shrq">
                            </div>
                        </div>
            ...
            if(confirm(msg) == true){
                ...
                if(spr.length <= 0 || spr == null || spr == undefined){
                    ...
                    if(sprq.length <= 0 || sprq == null || sprq == undefined){
                        ...
                        $.ajax({
                            url: "${pageContext.request.contextPath}/xsckd/spForbidden",
                            type: "GET",
                            data: {"djh":ddh,"spr":spr,"shrq":sprq},
                            dataType: "text",
                            //async: false,
                            success: function (data) {
                                $("#query").trigger("click");
            ...
            if(confirm(msg) == true) {
                ...
                if(spr.length <= 0 || spr == null || spr == undefined){
                    ...
                    if(sprq.length <= 0 || sprq == null || sprq == undefined){
                        ...
                        $.ajax({
                            url: "${pageContext.request.contextPath}/xsckd/spAdopt",
                            type: "GET",
                            data: {"djh":ddh,"spr":spr,"shrq":sprq},
                            dataType: "text",
                            //async: false,
